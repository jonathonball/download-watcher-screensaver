...
- Configurable refresh interval for file metadata refresh
  - Default is once every 2 seconds
  - Adjustable once per second and once every 5 minutes
...
## Download
1. Navigate to [Releases](https://github.com/jonathonball/download-watcher-screensaver/releases)
2. Download `File Watcher*.scr`

## Building
*Skip this step if you downloaded the .scr file from GitHub*
...
## Installation
**After following *Building* instructions**
...
**After following *Download* instructions**
1. Navigate to your Downloads folder
2. Right click on the `.scr` file you downloaded earlier and select **Install**
